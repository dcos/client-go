...
func (o *ServiceUpdateParams) WithBody(body *models.ServiceUpdateRequest) *ServiceUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the service update params
func (o *ServiceUpdateParams) SetBody(body *models.ServiceUpdateRequest) {
	o.Body = body
}
