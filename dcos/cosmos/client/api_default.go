...
@return SystemHealth
*/
func (a *DefaultApiService) DcosSystemHealth(ctx context.Context) (SystemHealth, *http.Response, error) {
	var (
		...
		localVarReturnValue  SystemHealth
	)
...
@return SystemNodes
*/
func (a *DefaultApiService) DcosSystemNodes(ctx context.Context) (SystemNodes, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  SystemNodes
	)
 ...
 * @param appId
*/
func (a *DefaultApiService) HealthchechService(ctx context.Context, appId string) (*http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/{appId}/v1/health"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param appId
@return KubernetesAuthDataResponse
*/
func (a *DefaultApiService) KubernetesAuthData(ctx context.Context, appId string) (KubernetesAuthDataResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  KubernetesAuthDataResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/{appId}/v1/auth/data"
	localVarPath = strings.Replace(localVarPath, "{"+"appId"+"}", fmt.Sprintf("%v", appId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v KubernetesAuthDataResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
func (a *DefaultApiService) PackageDescribe(ctx context.Context, localVarOptionals *PackageDescribeOpts) (V3PackageDescribeResponse, *http.Response, error) {
	var (
...
*/
func (a *DefaultApiService) PackageInstall(ctx context.Context, installRequest InstallRequest) (InstallResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Post")
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *DefaultApiService) PackageRepositoryAdd(ctx context.Context, localVarOptionals *PackageRepositoryAddOpts) (PackageAddRepoResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Post")
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *DefaultApiService) PackageRepositoryDelete(ctx context.Context, localVarOptionals *PackageRepositoryDeleteOpts) (PackageDeleteRepoResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Post")
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param searchRequest
 * @param optional nil or *PackageSearchOpts - Optional Parameters:
...
func (a *DefaultApiService) PackageSearch(ctx context.Context, searchRequest SearchRequest, localVarOptionals *PackageSearchOpts) (SearchResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Post")
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// to determine the Accept header
	localVarHttpHeaderAccepts := []string{"application/vnd.dcos.package.search-response+json;charset=utf-8;version=v1"}
...
func (a *DefaultApiService) PackageUninstall(ctx context.Context, uninstallRequest UninstallRequest, localVarOptionals *PackageUninstallOpts) (UninstallResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Post")
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *DefaultApiService) ServiceDescribe(ctx context.Context, localVarOptionals *ServiceDescribeOpts) (ServiceDescribeResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Post")
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *DefaultApiService) ServicePlan(ctx context.Context, appId string, plan string) (PlanDefinition, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PlanDefinition
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/{appId}/v1/plans/{plan}"
	localVarPath = strings.Replace(localVarPath, "{"+"appId"+"}", fmt.Sprintf("%v", appId), -1)
...
*/
func (a *DefaultApiService) ServiceUpdate(ctx context.Context, serviceUpdateRequest ServiceUpdateRequest) (ServiceUpdateResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Post")
		localVarPostBody     interface{}
		localVarFormFileName string
