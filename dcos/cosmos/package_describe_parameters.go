...
type PackageDescribeParams struct {
	...
	/*Body*/
	Body *types.PackageDescribeRequest
...
func (o *PackageDescribeParams) WithBody(body *types.PackageDescribeRequest) *PackageDescribeParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the package describe params
func (o *PackageDescribeParams) SetBody(body *types.PackageDescribeRequest) {
	o.Body = body
}
